...
const SellerLogin = () => {
    ...
    const [email, setEmail] = useState("dev@seller.com");
  ...
  return !isSeller && (
    <form onSubmit={onSubmitHandler} className='min-h-screen flex justify-center items-center text-sm text-gray-600'>
      <div className='flex flex-col gap-5 auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-lg shadow-xl border border-gray-200'>
